...
class PanelEjeEstructura(ttk.Frame):
    ...
    def _build(self):
        ...
        ttk.Label(f_info, text="Estructuras a barrer (separadas por comas):", style="Params.TLabel").grid(row=0, column=0, sticky="w", padx=ui(4), pady=ui(2))
        ...
        ttk.Label(f_info, text="Espera conmutación relé (s):", style="Params.TLabel").grid(row=1, column=0, sticky="w", padx=ui(4), pady=ui(2))
